SYSROOT=/usr/local/android-ndk-r10e-urmetiotc/platforms/android-9/arch-arm
PREFIX=${SYSROOT}/usr
CC=gcc
CROSS=arm-linux-androideabi-
CFLAGS=-fPIE -fPIC -DDEBUG -std=c99 -DANDROID ${OPTIONS} \
	--sysroot=${SYSROOT} \
	-I${PREFIX}/include \
...
MQTT_LIBS=/home/federico/urmetiotc/libs.android/12_mosquitto_1.4.2/lib
